...
def create_spark_session():
    ...
    spark = SparkSession.builder \
        .appName("IoTSensorsDiagnosticTool") \
...
def diagnose_json_files(spark):
    ...
    print("=" * 80)
    print("🔍 DIAGNOSTIC DES FICHIERS JSON IOT SENSORS")
    print("=" * 80)
    ...
    try:
        ...
        try:
            processed_files_path = "s3a://iot-sensors/metadata/processed_json_files.json"
...
def main():
    ...
    print("🚀 DÉMARRAGE DU DIAGNOSTIC JSON IOT SENSORS")
    ...
    try:
        ...
        print(f"\n✅ DIAGNOSTIC IOT SENSORS TERMINÉ")
        print(f"\n💡 RECOMMANDATIONS:")
        print(f"   1. Vérifiez si le nombre total d'enregistrements correspond à vos attentes")
        print(f"   2. Si les fichiers contiennent plus de données IoT, le problème peut être:")
